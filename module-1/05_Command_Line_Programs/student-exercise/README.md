...
Write a command line program which prompts the user for a series of integer values separated by spaces. Each integer is displayed along with its equivalent binary value. You may find the answer to this StackOverflow question to be useful in displaying the binary equivalent of an integer: https://stackoverflow.com/questions/2954962/convert-integer-to-binary-in-c-sharp
